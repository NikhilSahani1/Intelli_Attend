...
def attendance_log():
    ...
    try:
        ...
        for record in attendance_records:
            ...
            attendance_list.append({
                ...
                'verified': record['verified']  # This should be 0 or 1
            })
    except Exception as e:
    ...
    return render_template('attendance/attendance_log.html', attendance=attendance_list)
...
def auto_detect_face():
    ...
    try:
        ...
        CONFIDENCE_THRESHOLD = 120  # Lower = stricter (100-120 is good)
...
def enroll_face_multiple():
    ...
    try:
        ...
        # Save image with timestamp and angle
        timestamp = datetime.now().strftime('%Y%m%d_%H%M%S_%f')
        ...
        return jsonify({
            'success': True,
            'message': f'Face captured ({angle} angle)',
            'filename': filename
        })
